...
@section('scripts')
    <script type="text/javascript">
        ...
        function custom_form()
        {
            ...
            html += '<label for="user_role">Select User Type: <span class="text-danger">*</span></label>';
            html += '<select class="form-control" id="user_role" name="user_role">';
            html += '<option value="Laboratory Head">Laboratory Head</option>';
            html += '<option value="Laboratory In-charge">Laboratory In-charge</option>';
            html += '</select></div></div>';
            html += '<div class="col-lg-6">';
            html += '<div class="form-group">';
            html += '<label for="laboratory">Select Laboratory: <span class="text-danger">*</span></label>';
            html += '<select class="form-control" id="laboratory" name="laboratory">';
            html += '<option value="HM Laboratory">HM Laboratory</option>';
            html += '<option value="Science Laboratory">Science Laboratory</option>';
            html += '</select></div></div>';
            $('#addModalContent').append(html);
            $('#updateModalContent').append(html);
        }
                ...
                if ($('#addForm').valid()) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            // Serialize form data and manually append the `custom` field
